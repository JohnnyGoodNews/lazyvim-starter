...
-- Move to window using the <ctrl> hjkl keys (hnei)
...
map("n", "E", "'nN'[v:searchforward].'zv'", { expr = true, desc = "Prev Search Result" })
map("x", "E", "'nN'[v:searchforward]", { expr = true, desc = "Prev Search Result" })
map("o", "E", "'nN'[v:searchforward]", { expr = true, desc = "Prev Search Result" })
